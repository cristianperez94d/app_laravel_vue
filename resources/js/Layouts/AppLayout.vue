        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link :href="route('cities.index')" >
                                    Ciudades
                                </jet-nav-link>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :href="route('cities.index')" :active="route().current('cities')">
                            Ciudades
                        </jet-responsive-nav-link>
            ...
            <main>
                <div v-if="$page.props.flash.status">
                    <div class="alert alert-success">{{$page.props.flash.status}}</div>
                </div>
                <slot></slot>
            </main>
